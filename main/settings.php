...
<div class="flex-container" id="top-bottom">
    <div class="flex-container settings-container" id="name">
        <h1 class="heading">Nutzername: <?= $res_username[0]['Vorname'] ?> <?= $res_username[0]['Nachname'] ?></h1>
        ...
        <form class="edit-form hide-form" id="username-form" method="GET" action="./user/editUsername.php">
            ...
            <div class="input-wrapper">
                <div class="inputField">
                    <input type="text" class="inputField-input" id="vorname-input-field" name="new_vorname"
                           placeholder="Vorname" value="<?= $res_username[0]['Vorname'] ?>"/>
                    <label class="inputField-label">Vorname:</label>
                </div>
                <div class="inputField">
                    <input type="text" class="inputField-input" id="nachname-input-field" name="new_nachname"
                           placeholder="Nachname" value="<?= $res_username[0]['Nachname'] ?>"/>
            ...
            <div class="edit-form-btn-wrapper">
                ...
                <span onclick="closeForm('username-form')" id="username-reset" class="edit-form-btn reset-btn">Abbrechen</span>
            </div>
        </form>
    </div>
    <div class="flex-container settings-container" id="email">
        <h1 class="heading">Email-Adresse: <?= $res_username[0]['Email'] ?></h1>
        ...
        <form class="edit-form hide-form" id="email-form" method="GET" action="./user/editEmail.php">
            ...
            <div class="input-wrapper">
                <div class="inputField">
                    <input type="email" class="inputField-input" id="email-input-field" name="new_email"
                           placeholder="Email-Adresse" value="<?= $res_username[0]['Email'] ?>"/>
                    <label class="inputField-label">Email-Adresse:</label>
                </div>
            </div>
            <div class="edit-form-btn-wrapper">
                <span onclick="submitForm('email-form')" class="edit-form-btn">Speichern</span>
                <span onclick="closeForm('email-form')" id="email-reset" class="edit-form-btn reset-btn">Abbrechen</span>
            </div>
        </form>
    </div>
    <div class="flex-container settings-container" id="password">
        ...
        <form class="edit-form hide-form" id="pw-form" method="POST" action="./user/editPassword.php">
            ...
            <div class="input-wrapper">
                <div class="inputField">
                    <input type="password" class="inputField-input" id="pw-input-field" name="new_pw"
                           placeholder="Password" value=""/>
                    <label class="inputField-label">Neues Passwort:</label>
                </div>
                <div class="inputField">
                    <input type="password" class="inputField-input" id="pw-repeat-input-field" name="new_pw_repeat"
            ...
            <div class="edit-form-btn-wrapper">
                ...
                <span onclick="closeForm('pw-form')" id="pw-reset" class="edit-form-btn reset-btn">Abbrechen</span>
            </div>
        </form>
    </div>
    <div class="flex-container settings-container" id="deleteAccount">
        ...
        <form class="edit-form hide-form" id="del-acc-form" method="DELETE" action="./user/deleteAcc.php">
            ...
            <div class="edit-form-btn-wrapper">
                ...
                <span onclick="closeForm('del-acc-form')" id="del-acc-reset" class="edit-form-btn reset-btn">Abbrechen</span>
            </div>
        </form>
    </div>
</div>
